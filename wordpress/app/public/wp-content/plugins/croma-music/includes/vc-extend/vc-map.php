	...
	function iron_register_js_composer() {
		...
		vc_add_params('vc_custom_heading', array(
			array(
				...
				'value' => array(
					esc_html_x("No", 'VC', 'croma')=> 0,
					esc_html_x("Yes", 'VC', 'croma')=> 1,
				),
				'save_always' => true,
			),
			/*array(
				...
				'value' => array(
					esc_html_x("Left", 'VC', 'croma')=> 'fit_bg_left',
					esc_html_x("Center", 'VC', 'croma')=> "fit_bg_center",
					esc_html_x("Right", 'VC', 'croma')=> "fit_bg_right",
				),
			),
			array(
				'type' => 'textfield',
		...
		vc_add_params('vc_single_image', array(
			array(
				...
				'value' => array(
					esc_html_x("No", 'VC', 'croma')=> 0,
					esc_html_x("Yes", 'VC', 'croma')=> "img_fullwidth",
				),
				'save_always' => true,
			),
        ));
        ...
        vc_add_params('vc_btn',array(
        	array(
				...
				"holder" => "div",
				"class" => "",
				"heading" => esc_html_x("Choose an album", 'VC', 'croma'),
				"param_name" => "albums",
				"value" => '',
				"description" => esc_html_x("Which album do you want to play when user clicks on your button ?", 'VC', 'croma'),
				'dependency' => array(
		...
		vc_map( array(
		   "name" => esc_html_x("Audio Player", 'VC', 'croma'),
		   "base" => "iron_audioplayer",
		   "class" => "",
		   "icon" => "iron_vc_icon_audio_player",
		   "category" => esc_html_x('IRON Widgets', 'VC', 'croma'),
		   "params" => array(
		      array(
		         "type" => "textfield",
		         "holder" => "div",
		         "class" => "",
		         "heading" => esc_html_x("Title", 'VC', 'croma'),
		         "param_name" => "title",
		         "value" => "",
		         "description" => '',
		      ),
		      array(
		         ...
		         "holder" => "div",
		         "class" => "",
		         "heading" => esc_html_x("Albums", 'VC', 'croma'),
		         "param_name" => "albums",
		         "value" => '',
		         "description" => '',
		      ),
		      array(
		         ...
		         "holder" => "div",
		         "class" => "",
		         "heading" => esc_html_x("Auto Play", 'VC', 'croma'),
		         "param_name" => "autoplay",
		         "value" => array(
	                esc_html_x("No", 'VC', 'croma')=> 0,
	                esc_html_x("Yes", 'VC', 'croma')=> 1,
		      ...
		      array(
		         ...
		         "holder" => "div",
		         "class" => "",
		         "heading" => esc_html_x("Show Playlist", 'VC', 'croma'),
		      ...
		      array(
		         ...
		         "holder" => "div",
		         "class" => "",
		         "heading" => esc_html_x("Call To Action Title", 'VC', 'croma'),
		      ...
		      array(
		         ...
		         "holder" => "div",
		         "class" => "",
		         "heading" => esc_html_x("Call To Action Page", 'VC', 'croma'),
		      ...
		      array(
		         ...
		         "holder" => "div",
		         "class" => "",
		         "heading" => esc_html_x("Call To Action External Link", 'VC', 'croma'),
		      ...
		      array(
		         ...
		         "holder" => "div",
		         "class" => "",
		         "heading" => esc_html_x("CSS Animation", 'VC', 'croma'),
		...
		vc_map( array(
		   "name" => esc_html_x("Discography", 'VC', 'croma'),
		   ...
		   "params" => array(
		      ...
		      array(
		         ...
		         "holder" => "div",
		         "class" => "",
		         "heading" => esc_html_x("Filter by Artists", 'VC', 'croma'),
		...
		vc_map( array(
		   "name" => esc_html_x("Twitter", 'VC', 'croma'),
		   "base" => "iron_twitter",
		   "class" => "",
		   ...
		   "params" => array(
		      ...
		      array(
		         ...
		         "holder" => "div",
		         "class" => "",
		         "heading" => esc_html_x('Screen Name (ex: @IronTemplates)', 'VC', 'croma'),
		...
		vc_map( array(
		   "name" => esc_html_x("Videos", 'VC', 'croma'),
		   ...
		   "params" => array(
		      ...
		      array(
		         ...
		         "holder" => "div",
		         "class" => "",
		         "heading" => esc_html_x("Number of videos to show (*apply only for categories):", 'VC', 'croma'),
		         "param_name" => "number",
		         "value" => '',
		         "description" => '',
		      ),
		      array(
		         ...
		         "holder" => "div",
		         "class" => "",
		         "heading" => esc_html_x("Select one or multiple categories", 'VC', 'croma'),
		         "param_name" => "category",
		         "description" => '',
		      ),
		      array(
		         ...
		         "holder" => "div",
		         "class" => "",
		         "heading" => esc_html_x("Select Videos", 'VC', 'croma'),
		         "param_name" => "include",
		         "description" => '',
		      ),
		      array(
		       ...
		       array(
		         ...
		         "holder" => "div",
		         "class" => "",
		         "heading" => esc_html_x("What happens when you click the video's thumbnails ?", 'VC', 'croma'),
		         "param_name" => "video_link_type",
		         "value" => array(
	                esc_html_x("Go to detailed video page", 'VC', 'croma') => 'single',
	                esc_html_x("Open video in a LightBox", 'VC', 'croma') => 'lightbox',
	                esc_html_x("Replace image by video", 'VC', 'croma') => 'inline',
	              ),
		         "description" => '',
		         'save_always' => true,
		      ),
		      array(
		         ...
		         "holder" => "div",
		         "class" => "",
		         "heading" => esc_html_x("View As", 'VC', 'croma'),
		         "param_name" => "view",
		         "value" => array(
	                esc_html_x("List", 'VC', 'croma')=> 'video_list',
	                esc_html_x("Grid", 'VC', 'croma')=> 'video_grid',
	              ),
		         "description" => '',
		         'save_always' => true,
		      ),
		...
		vc_map( array(
		   "name" => esc_html_x("Events", 'VC', 'croma'),
		   "base" => "iron_events",
		   "class" => "",
		   ...
		   "params" => array(
		      ...
		      array(
		         ...
		         "holder" => "div",
		         "class" => "",
		         "heading" => esc_html_x("Number of events to show", 'VC', 'croma'),
		         "param_name" => "number",
		         "value" => '',
		         "description" => '',
		      ),
		      array(
		         ...
		         "holder" => "div",
		         "class" => "",
		         "heading" => esc_html_x("Filter by", 'VC', 'croma'),
		         "param_name" => "filter",
				 "value" => array(
	                esc_html_x("Upcoming Events", 'VC', 'croma')=> 'upcoming',
					esc_html_x("Past Events", 'VC', 'croma') => 'past'
	              ),
		         "description" => '',
		         'save_always' => true,
		      ),
		      ...
		      array(
		         ...
		         "holder" => "div",
		         "class" => "",
		         "heading" => esc_html_x("Enable Artists Filter ", 'VC', 'croma'),
		         "param_name" => "enable_artists_filter",
				 "value" => array(
	                esc_html_x("No", 'VC', 'croma')=> '',
					esc_html_x("Yes", 'VC', 'croma') => 'yes'
	              ),
		         "description" => '',
		         'save_always' => true,
		      ),
		...
		if (function_exists('is_plugin_active') && is_plugin_active('nmedia-mailchimp-widget/nm_mailchimp.php')) {
			...
			vc_map( array(
			   "name" => esc_html_x("Newsletter", 'VC', 'croma'),
			   ...
			   "params" => array(
			      ...
			      array(
			         ...
			         "holder" => "div",
			         "class" => "",
			         "heading" => esc_html_x("Description", 'VC', 'croma'),
			      ...
			      array(
			         ...
			         "holder" => "div",
			         "class" => "",
			         "heading" => esc_html_x("Newsletters", 'VC', 'croma'),
			         "param_name" => "fid",
					 "value" => $newsletters,
			         "description" => '',
			         'save_always' => true,
		...
		vc_map( array(
			"name" => esc_html_x("Promotion", 'VC', 'croma'),
			"base" => "iron_promotion",
			"class" => "",
			...
			"params" => array(
				array(
					"param_name" => "image",
					"type" => "attach_image",
					"heading" => esc_html_x('Image', 'VC', 'croma'),
					"description" => ''
				),
				array(
					"param_name" => "title",
		        ...
		        array(
		          ...
		          "type" => "dropdown",
		          "heading" => esc_html_x("Title Tag Name", 'VC', 'croma'),
		          "value" => array(
		              "h3" => "h3",
		              "h2" => "h2",
		              "h4" => "h4",
				...
				array(
			      ...
			      "type" => "colorpicker",
			      "heading" => esc_html_x('Title Color', 'VC', 'croma'),
			      "description" => '',
			      "value" => "",
			    ),
				array(
					...
					"holder" => "div",
					"class" => "",
					"heading" => esc_html_x('Subtitle', 'VC', 'croma'),
					"value" => "",
					"description" => '',
				),
		        array(
		          ...
		          "type" => "dropdown",
		          "heading" => esc_html_x("Subtitle Tag Name", 'VC', 'croma'),
		          "value" => array(
		              "h3" => "h3",
		              "h2" => "h2",
		              "h4" => "h4",
				...
				array(
			      ...
			      "type" => "colorpicker",
			      "heading" => esc_html_x('Subtitle Color', 'VC', 'croma'),
			      "description" => '',
			      "value" => "",
			    ),
				array(
			      ...
			      "type" => "dropdown",
			      "heading" => esc_html_x('Title Align', 'VC', 'croma'),
			      "value" => array(
							esc_html_x('Left', 'VC', 'croma') => 'left',
							esc_html_x('Center', 'VC', 'croma') => 'center',
							esc_html_x('Right', 'VC', 'croma') => 'right',
						),
			    ),
				array(
					...
					"holder" => "div",
					"class" => "",
					"heading" => esc_html_x('Line height', 'VC', 'croma'),
					"value" => "",
					"description" => '',
				),
			    array(
			      ...
			      "type" => "colorpicker",
			      "heading" => esc_html_x('Overlay Color', 'VC', 'croma'),
			      "description" => '',
			      "value" => "rgb(0,0,0)",
			    ),
				array(
					...
					"holder" => "div",
					"class" => "",
					"heading" => esc_html_x("Link Page", 'VC', 'croma'),
					"value" => '',
					"description" => ''
				),
				array(
					...
					"holder" => "div",
					"class" => "",
					"heading" => esc_html_x("Link Product", 'VC', 'croma'),
					"value" => '',
					"description" => ''
				),
				array(
					...
					"holder" => "div",
					"class" => "",
					"heading" => esc_html_x("Link External", 'VC', 'croma'),
					"value" => '',
					"description" => '',
				),
				array(
			      ...
			      "type" => "dropdown",
			      "heading" => esc_html_x('Hover Animation', 'VC', 'croma'),
			      "value" => array(
							esc_html_x('Slide', 'VC', 'croma') => 'slide',
							esc_html_x('Zoom', 'VC', 'croma') => 'zoom',
						),
			    ),
				array(
			         "type" => "dropdown",
...
/*
		...
		vc_map( array(
			"name" => esc_html_x("InfoBox", 'VC', 'croma'),
			"base" => "iron_infobox",
			"class" => "",
			...
			"params" => array(
				...
				array(
					...
					"holder" => "div",
					"class" => "",
					"heading" => esc_html_x('Icon', 'VC', 'croma'),
					"value" => $font_icons,
					"description" => '',
				),
				array(
...
*/
		...
		vc_map( array(
			"name" => esc_html_x("Image Divider", 'VC', 'croma'),
			...
			"params" => array(
				array(
					...
					"type" => "attach_image",
					"heading" => esc_html_x('Divider Image', 'VC', 'croma'),
					"description" => ''
				),
		    array(
		      "param_name" => "divider_color",
		      "type" => "colorpicker",
		      "heading" => esc_html_x('Divider Color', 'VC', 'croma'),
		      "description" => 'If no image chosen, the default css divider will be used',
		    ),
		    array(
		      "param_name" => "divider_align",
		      "type" => "dropdown",
		      "heading" => esc_html_x('Divider Align', 'VC', 'croma'),
		      "value" => array(
						esc_html_x('Left', 'VC', 'croma') => 'left',
						esc_html_x('Center', 'VC', 'croma') => 'center',
						esc_html_x('Right', 'VC', 'croma') => 'right',
				...
				array(
					...
					"holder" => "div",
					"class" => "",
					"heading" => esc_html_x('Divider Padding Top', 'VC', 'croma'),
					"value" => "",
					"description" => '',
				),
				array(
					...
					"holder" => "div",
					"class" => "",
					"heading" => esc_html_x('Divider Padding Bottom', 'VC', 'croma'),
					"value" => "",
					"description" => '',
				),
			)
		...
		vc_map( array(
			...
			'params' => array(
		      array(
		         ...
		         "holder" => "div",
		         "class" => "",
		         "heading" => esc_html_x("Text", 'VC', 'croma'),
		         "param_name" => "text",
		         "value" => '',
		         "description" => '',
		      ),
		      array(
				  ...
				  "type" => "dropdown",
				  "heading" => esc_html_x('Text Align', 'VC', 'croma'),
				  "value" => array(
						esc_html_x('Left', 'VC', 'croma') => 'left',
						esc_html_x('Center', 'VC', 'croma') => 'center',
						esc_html_x('Right', 'VC', 'croma') => 'right',
		      ...
		      array(
		         ...
		         "holder" => "div",
		         "class" => "",
		         "heading" => esc_html_x("Border Width (px)", 'VC', 'croma'),
		      ...
		      array(
		         ...
		         "holder" => "div",
		         "class" => "",
		         "heading" => esc_html_x("Border Radius (px)", 'VC', 'croma'),
			  ...
			  array(
		         ...
		         "holder" => "div",
		         "class" => "",
		         "heading" => esc_html_x("Horizontal Padding (px)", 'VC', 'croma'),
			  ...
			  array(
		         ...
		         "holder" => "div",
		         "class" => "",
		         "heading" => esc_html_x("Vertical Padding (px)", 'VC', 'croma'),
		      ...
		      array(
			      "type" => "colorpicker",
				  "heading" => esc_html_x("Border Color", 'VC', 'croma'),
			      "param_name" => "border_color",
			      "description" => '',
			    ),
			    array(
			      "type" => "colorpicker",
				  "heading" => esc_html_x("Background Color", 'VC', 'croma'),
			      "param_name" => "background_color",
			      "description" => '',
			    ),
			    array(
			      "type" => "colorpicker",
				  "heading" => esc_html_x("Text Color", 'VC', 'croma'),
			      "param_name" => "text_color",
			      "description" => '',
			    ),
			    array(
			      "type" => "colorpicker",
				  "heading" => esc_html_x("Hover Border Color", 'VC', 'croma'),
			      "param_name" => "hover_border_color",
			      "description" => '',
			    ),
			    array(
			      "type" => "colorpicker",
				  "heading" => esc_html_x("Hover Background Color", 'VC', 'croma'),
			      "param_name" => "hover_bg_color",
			      "description" => '',
			    ),
			    array(
			      "type" => "colorpicker",
				  "heading" => esc_html_x("Hover Text Color", 'VC', 'croma'),
		...
		vc_map( array(
			"name" => esc_html_x("Countdown", 'VC', 'croma'),
			"base" => "iron_countdown",
			"class" => "",
			...
			"params" => array(
				...
				array(
					...
					"heading" => esc_html_x('End Time', 'VC', 'croma'),
					"value" => "",
					"description" => '',
					"group" => esc_html_x('General', 'VC', 'croma'),
				...
				array(
					...
					"holder" => "div",
					"class" => "",
					"heading" => esc_html_x('Now Time Type', 'VC', 'croma'),
					 "value" => array(
						esc_html_x('Use Local Time', 'VC', 'croma') => 'timezone',
						esc_html_x('Use server time', 'VC', 'croma') => 'server',
					),
					"description" => '',
					"group" => esc_html_x('General', 'VC', 'croma'),
					'save_always' => true,
				...
				array(
					...
					"holder" => "div",
					"class" => "",
					"heading" => esc_html_x('Show Months', 'VC', 'croma'),
					"value" => array(
						esc_html_x("No", 'VC', 'croma')=> 0,
						esc_html_x("Yes", 'VC', 'croma')=> 1,
					),
				...
				array(
					...
					"holder" => "div",
					"class" => "",
					"heading" => esc_html_x('Show Days', 'VC', 'croma'),
					"value" => array(
						esc_html_x("No", 'VC', 'croma')=> 0,
						esc_html_x("Yes", 'VC', 'croma')=> 1,
					),
				...
				array(
					...
					"holder" => "div",
					"class" => "",
					"heading" => esc_html_x('Show Hours', 'VC', 'croma'),
					"value" => array(
						esc_html_x("No", 'VC', 'croma')=> 0,
						esc_html_x("Yes", 'VC', 'croma')=> 1,
					),
				...
				array(
					...
					"holder" => "div",
					"class" => "",
					"heading" => esc_html_x('Show Minutes', 'VC', 'croma'),
					"value" => array(
						esc_html_x("No", 'VC', 'croma')=> 0,
						esc_html_x("Yes", 'VC', 'croma')=> 1,
					),
				...
				array(
					...
					"holder" => "div",
					"class" => "",
					"heading" => esc_html_x('Show Seconds', 'VC', 'croma'),
					"value" => array(
						esc_html_x("No", 'VC', 'croma')=> 0,
						esc_html_x("Yes", 'VC', 'croma')=> 1,
					),
				...
				array(
					...
					"holder" => "div",
					"class" => "",
					"heading" => esc_html_x('Show labels under countdown', 'VC', 'croma'),
					"value" => array(
						esc_html_x("No", 'VC', 'croma')=> 0,
						esc_html_x("Yes", 'VC', 'croma')=> 1,
					),
...
/*
				array(
					...
					"holder" => "div",
					"class" => "",
					"heading" => esc_html_x('Character separator', 'VC', 'croma'),
					"value" => "",
					"description" => 'eg.: : \ - / _',
					"group" => esc_html_x('General', 'VC', 'croma'),
				),
*/
				array(
					...
					"holder" => "div",
					"class" => "",
					"heading" => esc_html_x('Numbers Font Style', 'VC', 'croma'),
					"value" => "",
					"description" => '',
					"group" => esc_html_x('Design', 'VC', 'croma'),
				),
				array(
					...
					"holder" => "div",
					"class" => "",
					"heading" => esc_html_x('Labels Font Style', 'VC', 'croma'),
					"value" => "",
					"description" => '',
					"group" => esc_html_x('Design', 'VC', 'croma'),
				),
				array(
			      "type" => "colorpicker",
				  "heading" => esc_html_x("Font Color", 'VC', 'croma'),
				...
				array(
					...
					"holder" => "div",
					"class" => "",
					"heading" => esc_html_x('Countdown Separator', 'VC', 'croma'),
					"value" => "",
				...
				array(
					...
					"holder" => "div",
					"class" => "",
					"heading" => esc_html_x('Align labels', 'VC', 'croma'),
					"value" => array(
						esc_html_x("Left", 'VC', 'croma')=> 'left',
						esc_html_x("Center", 'VC', 'croma')=> 'center',
						esc_html_x("Right", 'VC', 'croma')=> 'right',
				...
				array(
					...
					"holder" => "div",
					"class" => "",
					"heading" => esc_html_x('Numbers Font Size (px)', 'VC', 'croma'),
					"value" => "",
					"description" => '',
					"group" => esc_html_x('Desktop', 'VC', 'croma'),
				),
				array(
					...
					"holder" => "div",
					"class" => "",
					"heading" => esc_html_x('Numbers Line Height (px)', 'VC', 'croma'),
					"value" => "",
					"description" => '',
					"group" => esc_html_x('Desktop', 'VC', 'croma'),
				),
				array(
					...
					"holder" => "div",
					"class" => "",
					"heading" => esc_html_x('Numbers Letter Spacing (px)', 'VC', 'croma'),
					"value" => "",
					"description" => '',
					"group" => esc_html_x('Desktop', 'VC', 'croma'),
				),
				array(
					...
					"holder" => "div",
					"class" => "",
					"heading" => esc_html_x('Labels Font Size (px)', 'VC', 'croma'),
					"value" => "",
					"description" => '',
					"group" => esc_html_x('Desktop', 'VC', 'croma'),
				),
				array(
					...
					"holder" => "div",
					"class" => "",
					"heading" => esc_html_x('Labels Line Height (px)', 'VC', 'croma'),
					"value" => "",
					"description" => '',
					"group" => esc_html_x('Desktop', 'VC', 'croma'),
				),
				array(
					...
					"holder" => "div",
					"class" => "",
					"heading" => esc_html_x('Labels Letter Spacing (px)', 'VC', 'croma'),
					"value" => "",
					"description" => '',
					"group" => esc_html_x('Desktop', 'VC', 'croma'),
				),
				array(
					...
					"holder" => "div",
					"class" => "",
					"heading" => esc_html_x('Spacing between Numbers (px)', 'VC', 'croma'),
					"value" => "",
					"description" => '',
					"group" => esc_html_x('Desktop', 'VC', 'croma'),
				),
				array(
					...
					"holder" => "div",
					"class" => "",
					"heading" => esc_html_x('Margin between Numbers and sub labels (px)', 'VC', 'croma'),
					"value" => "",
					"description" => '',
					"group" => esc_html_x('Desktop', 'VC', 'croma'),
				),
				...
				array(
					...
					"value" => "",
					"description" => '',
					"group" => esc_html_x('Tablet', 'VC', 'croma'),
				),
				array(
				...
				array(
					...
					"value" => "",
					"description" => '',
					"group" => esc_html_x('Mobile', 'VC', 'croma'),
				),
				array(
