...
function ironFeatures_widgets_init(){
	...
	$iron_widgets = array(
		  'Iron_Widget_Radio'           => esc_html_x('croma: Radio Player', 'Widget', 'croma')
		, 'Iron_Widget_Twitter'         => esc_html_x('croma: Twitter', 'Widget', 'croma')
		, 'Iron_Widget_Terms'           => esc_html_x('croma: Terms', 'Widget', 'croma')
		, 'Iron_Widget_Posts'    		=> esc_html_x('croma: News', 'Widget', 'croma')
		, 'Iron_Widget_Videos'   		=> esc_html_x('croma: Videos', 'Widget', 'croma')
	);
...
class Iron_Widget_Radio extends Iron_Music_Widget
{
	...
	function __construct ()
	{
		$widget_ops = array(
			...
			, 'description' => esc_html_x('A simple radio that plays a list of songs from selected albums.', 'Widget', 'croma')
		);
		...
		parent::__construct('iron-radio', esc_html_x('croma: Radio Player', 'Widget', 'croma'), $widget_ops);
	...
	public function widget ( $args, $instance )
	{
		...
		if ( isset($playlist['tracks']) && ! empty($playlist['tracks']) )
			$player_message = esc_html_x('Loading tracks...', 'Widget', 'croma');
		else
			$player_message = esc_html_x('No tracks founds...', 'Widget', 'croma');
		...
		foreach( $playlist['tracks'] as $track){
			...
			$format_playlist .= '<li data-audiopath="' . esc_url( $trackUrl ) . '" data-showloading="' . $showLoading .'"  data-albumTitle="' . esc_attr( $track['album_title'] ) . '" data-albumArt="' . esc_url( $track['album_poster'] ) . '" data-trackTitle="' . $track['track_title'] . '">' . $store_buttons . '</li>';
		}
	...
	public function form ( $instance )
	{
		...
		if ( !empty( $all_albums ) ) :?>
			...
			<p>
				<label for="<?php echo $this->get_field_id('title'); ?>"><?php _ex('Title:', 'Widget', 'croma'); ?></label>
				<input type="text" class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" value="<?php echo $title; ?>" placeholder="<?php _e('Popular Songs', 'croma'); ?>" />
			</p>
			<p>
				<label for="<?php echo $this->get_field_id('albums'); ?>"><?php _ex('Album:', 'Widget', 'croma'); ?></label>
			...
			<p>
				<label for="<?php echo $this->get_field_id('action_title'); ?>"><?php _ex('Call To Action Title:', 'Widget', 'croma'); ?></label>
				<input type="text" class="widefat" id="<?php echo $this->get_field_id('action_title'); ?>" name="<?php echo $this->get_field_name('action_title'); ?>" value="<?php echo $action_title; ?>" placeholder="<?php _e('View More', 'croma'); ?>" />
			</p>
			<p>
				<label for="<?php echo $this->get_field_id('action_obj_id'); ?>"><?php _ex('Call To Call To Action Page:', 'Widget', 'croma'); ?></label>
				<select class="widefat" id="<?php echo $this->get_field_id('action_obj_id'); ?>" name="<?php echo $this->get_field_name('action_obj_id'); ?>">
					<?php echo $this->get_object_options($action_obj_id); ?>
				</select>
			</p>
			<p>
				<label for="<?php echo $this->get_field_id('action_ext_link'); ?>"><?php _ex('Call To Action External Link:', 'Widget', 'croma'); ?></label>
		...
		<?php
			...
			echo wp_kses_post( '<p>'. sprintf( _x('No albums have been created yet. <a href="%s">Create some</a>.', 'Widget', 'croma'), esc_url(admin_url('edit.php?post_type=album')) ) .'</p>' );
...
class Iron_Widget_Twitter extends Iron_Music_Widget
{
	...
	function __construct ()
	{
		$widget_ops = array(
			...
			, 'description' => esc_html_x('The most recent tweet.', 'Widget', 'croma')
		);
		...
		parent::__construct('iron-recent-tweets', esc_html_x('croma: Twitter', 'Widget', 'croma'), $widget_ops);
	}
...
?>
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php echo esc_html_x('Title:', 'Widget', 'croma'); ?></label>
			<input type="text" class="widefat" id="<?php echo esc_attr($this->get_field_id('title')); ?>" name="<?php echo esc_attr($this->get_field_name('title')); ?>" value="<?php echo esc_attr($title); ?>" placeholder="<?php esc_html_e('Live from Twitter', 'croma'); ?>" />
		</p>
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('screen_name')); ?>"><?php echo esc_html_x('Screen Name:', 'Widget', 'croma'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('action_title')); ?>"><?php echo esc_html_x('Call To Action Title:', 'Widget', 'croma'); ?></label>
			<input type="text" class="widefat" id="<?php echo esc_attr($this->get_field_id('action_title')); ?>" name="<?php echo esc_attr($this->get_field_name('action_title')); ?>" value="<?php echo esc_attr($action_title); ?>" placeholder="<?php esc_html_e('View More', 'croma'); ?>" />
		</p>
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('action_obj_id')); ?>"><?php echo esc_html_x('Call To Call To Action Page:', 'Widget', 'croma'); ?></label>
			<select class="widefat" id="<?php echo esc_attr($this->get_field_id('action_obj_id')); ?>" name="<?php echo esc_attr($this->get_field_name('action_obj_id')); ?>">
				<?php echo $this->get_object_options($action_obj_id); ?>
			</select>
		</p>
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('action_ext_link')); ?>"><?php echo esc_html_x('Call To Action External Link:', 'Widget', 'croma'); ?></label>
			<input type="text" class="widefat" id="<?php echo esc_attr($this->get_field_id('action_ext_link')); ?>" name="<?php echo esc_attr($this->get_field_name('action_ext_link')); ?>" value="<?php echo esc_attr($action_ext_link); ?>" />
		</p>
...
class Iron_Widget_Terms extends Iron_Music_Widget
{
	...
	function __construct ()
	{
		$widget_ops = array(
			...
			, 'description' => esc_html_x('A list or dropdown of terms', 'Widget', 'croma')
		);
		...
		parent::__construct('iron-terms', esc_html__('croma: Terms', 'croma'), $widget_ops);
	}
	...
	function widget ( $args, $instance )
	{
		...
		if ( $d ) :
			$term_args['show_option_none'] = esc_html__('Select Term', 'croma');
...
<?php
	...
	function form ( $instance )
	{
		...
		if ( ! $taxonomies ) {
			echo '<p>'. esc_html__('No taxonomies have been created yet.', 'croma') .'</p>';
			return;
		}

?>
		<p><label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php esc_html_e('Title:', 'croma'); ?></label>
		<input class="widefat" id="<?php echo esc_attr($this->get_field_id('title')); ?>" name="<?php echo esc_attr($this->get_field_name('title')); ?>" type="text" value="<?php echo esc_attr($title); ?>" placeholder="<?php esc_html_e('Categories', 'croma'); ?>" /></p>

		<p>
			<label for="<?php echo esc_attr($this->get_field_id('taxonomy')); ?>"><?php esc_html_e('Select Taxonomy:', 'croma'); ?></label>
		...
		<label for="<?php echo esc_attr($this->get_field_id('dropdown')); ?>"><?php esc_html_e('Display as dropdown', 'croma'); ?></label><br />

		<input type="checkbox" class="checkbox" id="<?php echo esc_attr($this->get_field_id('count')); ?>" name="<?php echo esc_attr($this->get_field_name('count')); ?>"<?php checked( $count ); ?> />
		<label for="<?php echo esc_attr($this->get_field_id('count')); ?>"><?php esc_html_e('Show post counts', 'croma'); ?></label><br />
<?php
...
class Iron_Widget_Posts extends Iron_Music_Widget
{
	...
	function __construct ()
	{
		$widget_ops = array(
			...
			, 'description' => esc_html_x('The most recent posts on your site.', 'Widget', 'croma')
		);
		...
		parent::__construct('iron-recent-posts', esc_html_x('croma: News', 'Widget', 'croma'), $widget_ops);
...
?>
		<p><label for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><?php esc_html_e('Title:', 'croma'); ?></label>
		<input class="widefat" id="<?php echo esc_attr($this->get_field_id( 'title' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'title' )); ?>" type="text" value="<?php echo esc_attr($title); ?>" placeholder="<?php esc_html_e('Latest News', 'croma'); ?>" /></p>

		<p><label for="<?php echo esc_attr($this->get_field_id( 'number' )); ?>"><?php esc_html_e('Number of posts to show:', 'croma'); ?></label>
		...
		<label for="<?php echo esc_attr($this->get_field_id( 'enable_excerpts' )); ?>"><?php esc_html_e('Display excerpts?', 'croma'); ?></label></p>


		<p><input class="checkbox" type="checkbox" <?php checked( $show_date ); ?> id="<?php echo esc_attr($this->get_field_id( 'show_date' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'show_date' )); ?>" />
		<label for="<?php echo esc_attr($this->get_field_id( 'show_date' )); ?>"><?php esc_html_e('Display post date?', 'croma'); ?></label></p>

		<p>
			<label for="<?php echo esc_attr($this->get_field_id('category')); ?>"><?php echo esc_html_x('Select one or multiple categories:', 'Widget', 'croma'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'view' )); ?>"><?php esc_html_e('View As:', 'croma'); ?></label>
			<select class="widefat" id="<?php echo esc_attr($this->get_field_id('view')); ?>" name="<?php echo esc_attr($this->get_field_name('view')); ?>">
				<option <?php echo ($view == 'post' ? 'selected' : ''); ?> value="post"><?php echo esc_html_x('List', 'Widget', 'croma'); ?></option>
				<option <?php echo ($view == 'post_grid' ? 'selected' : ''); ?> value="post_grid"><?php echo esc_html_x('Grid', 'Widget', 'croma'); ?></option>
				<option <?php echo ($view == 'post_simple' ? 'selected' : ''); ?> value="post_simple"><?php echo esc_html_x('Simple', 'Widget', 'croma'); ?></option>
			</select>
		<p>
...
class Iron_Widget_Videos extends Iron_Music_Widget
{
	...
	function __construct ()
	{
		...
		$widget_ops = array(
			...
			, 'description' => esc_html_x('The most recent videos on your site.', 'Widget', 'croma')
		);
		...
		parent::__construct('iron-recent-videos', esc_html_x('croma: Videos', 'Widget', 'croma'), $widget_ops);
...
?>
		<p><label for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><?php esc_html_e('Title:', 'croma'); ?></label>
		<input class="widefat" id="<?php echo esc_attr($this->get_field_id( 'title' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'title' )); ?>" type="text" value="<?php echo esc_attr($title); ?>" placeholder="<?php esc_html_e('Videos', 'croma'); ?>" /></p>

		<p><label for="<?php echo esc_attr($this->get_field_id( 'number' )); ?>"><?php esc_html_e('Number of videos to show (*apply only for categories):', 'croma'); ?></label>
		<input id="<?php echo esc_attr($this->get_field_id( 'number' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'number' )); ?>" type="text" value="<?php echo esc_attr($number); ?>" size="3" /></p>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('include')); ?>"><?php echo esc_html_x('Or Manually Select Videos:', 'Widget', 'croma'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'artists_filter' )); ?>"><?php esc_html_e('Filter By Artists:', 'croma'); ?></label>
			<select multiple class="widefat" id="<?php echo esc_attr($this->get_field_id('artists_filter')); ?>" name="<?php echo esc_attr($this->get_field_name('artists_filter')); ?>[]">
				<?php echo $this->get_object_options($artists_filter, 'artist'); ?>
			</select>
		</p>
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'video_link_type' )); ?>"><?php esc_html_e("What happens when you click the video's thumbnails ?", 'croma'); ?></label>
			<select class="widefat" id="<?php echo esc_attr($this->get_field_id('video_link_type')); ?>" name="<?php echo esc_attr($this->get_field_name('video_link_type')); ?>">
				<option <?php echo ($video_link_type == 'single' ? 'selected' : ''); ?> value="single"><?php echo esc_html_x('Go to detailed video page', 'Widget', 'croma'); ?></option>
				<option <?php echo ($video_link_type == 'lightbox' ? 'selected' : ''); ?> value="lightbox"><?php echo esc_html_x('Open video in a LightBox', 'Widget', 'croma'); ?></option>
				<option <?php echo ($video_link_type == 'inline' ? 'selected' : ''); ?> value="inline"><?php echo esc_html_x('Replace image by video', 'Widget', 'croma'); ?></option>
			</select>
		<p>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'view' )); ?>"><?php esc_html_e('View As:', 'croma'); ?></label>
			<select class="widefat" id="<?php echo esc_attr($this->get_field_id('view')); ?>" name="<?php echo esc_attr($this->get_field_name('view')); ?>">
				<option <?php echo ($view == 'video_list' ? 'selected' : ''); ?> value="video_list"><?php echo esc_html_x('List', 'Widget', 'croma'); ?></option>
				<option <?php echo ($view == 'video_grid' ? 'selected' : ''); ?> value="video_grid"><?php echo esc_html_x('Grid', 'Widget', 'croma'); ?></option>
			</select>
		<p>
...
class Iron_Widget_Ios_Slider extends Iron_Music_Widget
{
	...
	function __construct ()
	{
		$widget_ops = array(
			...
			, 'description' => esc_html_x('Touch Enabled, Responsive jQuery Horizontal Image Slider/Carousel.', 'Widget', 'croma')
		);
		...
		parent::__construct('iron-ios-slider', esc_html_x('croma: IOS Slider', 'Widget', 'croma'), $widget_ops);
...
?>
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php echo esc_html_x('Title:', 'Widget', 'croma'); ?></label>
				<input type="text" class="widefat" id="<?php echo esc_attr($this->get_field_id('title')); ?>" name="<?php echo esc_attr($this->get_field_name('title')); ?>" value="<?php echo esc_attr($title); ?>" placeholder="<?php esc_html_e('Popular Songs', 'croma'); ?>" />
			</p>
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('id')); ?>"><?php echo esc_html_x('IOS Sliders:', 'Widget', 'croma'); ?></label>
...
<?php
				...
				echo wp_kses_post( '<p>'. sprintf( esc_html_x('No photo albums have been created yet. <a href="%s">Create some</a>.', 'Widget', 'croma'), esc_url(admin_url('edit.php?post_type=photo-album')) ) .'</p>' );
