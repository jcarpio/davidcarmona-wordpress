	...
	register_field_group(array (
		...
		'fields' => array (
			array (
				...
				'instructions' => esc_html__('This will override global settings', 'croma'),
			...
			array (
				...
				'instructions' => esc_html__('Set the menu opacity between 0 and 1', 'croma'),
				'type' => 'number',
				'min' => 0,
				'max' => 1,
				'step' => 0.1,
			...
			array (
				...
				'instructions' => esc_html__('Only used when push menu is enabled', 'croma'),
			...
			array (
				...
				'name' => 'background',
				'instructions' => wp_kses( __('*Important*. If you want an image background, make sure that you ALSO set a Main Background Color AND set value "0" in the Main Background Transparency. Also, Background images will NOT be shown on mobile', 'croma'), iron_get_allowed_html() ),
				'type' => 'image',
				'save_format' => 'id',
				'preview_size' => 'medium',
				'library' => 'all',
			...
			array (
				...
				'instructions' => wp_kses( __('0 for transparent and 1 for 100% solid. If you set an image background - make sure to set this value to 0 AND set a fictive Background COLOR above', 'croma'), iron_get_allowed_html() ),
				'type' => 'number',
				'min' => 0,
				'max' => 1,
				'step' => 0.1,
	...
	register_field_group(array (
		...
		'fields' => array (
			...
			array (
				...
				'type' => 'text',
				'instructions' => esc_html__("Users will be redirected to the link's destination instead of the album's details page.", 'croma'),
				'default_value' => '',
				'placeholder' => '',
				'prepend' => '',
				'append' => '',
			...
			array (
				...
				'sub_fields' => array (
					...
					array (
						'key' => 'stream_link',
						'label' => 'Audio Stream link',
						'name' => 'stream_link',
						'type' => 'text',
						'instructions' => 'Add link to the audio stream',
						'column_width' => '',
						'default_value' => '',
						'formatting' => 'html',
						'maxlength' => '',
