...
if ( apply_filters( 'vc_custom_heading_template_use_wrapper', false ) ) {
	$iron_croma_output .= '<div class="' . esc_attr( $iron_croma_css_class ) . '" >';
	...
	$iron_croma_output .= '<' . $iron_croma_fonts['font_container_data']['values']['tag'] . ' ' . $iron_croma_style . ' class="' . esc_attr( $iron_croma_css_class ) . '">';
	$iron_croma_output .= $iron_croma_text;
	$iron_croma_output .= '</' . $iron_croma_fonts['font_container_data']['values']['tag'] . '>';
}
