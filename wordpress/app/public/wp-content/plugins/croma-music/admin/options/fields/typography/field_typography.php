	...
	function render() {
		...
		<tr>
			...
			<?php
				...
				echo '<label>'.esc_html__('Text Align', 'croma').'</label> ';
			...
			<?php
				...
				echo '<label>'.esc_html__('Font Size', 'croma').'</label> ';
		...
		<tr>
			...
			<?php
				...
				echo '<label>'.esc_html__('Transform', 'croma').'</label> ';
			...
			<?php
				...
				echo '<label>'.esc_html__('Line Height', 'croma').'</label> ';
		...
		<tr>
			...
			<?php
				...
				echo '<label>'.esc_html__('Font Weight', 'croma').'</label> ';
		...
		<tr>
			...
			<?php
				...
				echo '<label>'.esc_html__('Font Color', 'croma').'</label> ';
			...
			<?php
				...
				echo '<label>'.esc_html__('Background', 'croma').'</label> ';
