...
class Redux_Options_fontawesome {
    ...
    */
    function render() {
        echo '<p class="description" style="color:red;">' . wp_kses( __('The icons provided below are free to use custom icons from the <a href="http://fontawesome.io/" target="_blank">Font Awesome icons</a>', 'croma'),iron_get_allowed_html()) . '</p>';
