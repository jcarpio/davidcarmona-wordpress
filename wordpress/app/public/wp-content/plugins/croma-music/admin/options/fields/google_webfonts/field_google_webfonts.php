...
class Redux_Options_google_webfonts {
    ...
    */
    function render() {
        echo '<p class="description" style="color:red;">' . wp_kses( __('The fonts provided below are free to use custom fonts from the <a href="http://www.google.com/webfonts" target="_blank">Google Web Fonts directory</a>', 'croma'),iron_get_allowed_html()) . '</p>';
