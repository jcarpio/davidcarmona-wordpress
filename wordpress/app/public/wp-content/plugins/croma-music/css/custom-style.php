...
$iron_music_music_style->setFont('.iron-audioplayer .track-title, .continuousPlayer .track-name', 'music_player_song_title', true);
$iron_music_music_style->setFont('.iron-audioplayer .album-title, .continuousPlayer .album-title', 'music_player_album_title', true);
...
$music_player_hover_playlist = '.iron-audioplayer .playlist .audio-track:hover';
