<?php
$iron_croma_vid_url = esc_url( Iron_Croma::getField( 'video_url', $post->ID ) );
$iron_croma_embed = wp_oembed_get($iron_croma_vid_url);

if(!empty($_POST)) {
	die($iron_croma_embed);
}
