		...
		<header class="opacityzero">
			...
			<?php if( Iron_Croma::getOption('header_logo', null, get_template_directory_uri().'/images/logo.png') !== ''): ?>
				<a href="<?php echo esc_url( home_url('/'));?>" class="site-logo" title="<?php echo esc_attr( get_bloginfo('name') ); ?>">
					...
					<img id="menu-trigger" class="logo-desktop regular" src="<?php echo esc_url( $iron_croma_logo1x ); ?>" <?php echo ($iron_croma_logo1x)? 'data-at2x="' . esc_url($iron_croma_logo2x) .'"':''?> alt="<?php echo esc_attr( get_bloginfo('name') ); ?>">
			  		<!--<img id="menu-trigger" class="logo-desktop regular" src="<?php echo esc_url( Iron_Croma::getOption('header_logo', null, get_template_directory_uri().'/images/logo.png') ); ?>" <?php echo (Iron_Croma::getOption('retina_header_logo', null, get_template_directory_uri().'/images/logo.png'))? 'data-at2x="' . esc_url( Iron_Croma::getOption('retina_header_logo', null, get_template_directory_uri().'/images/logo.png')) .'"':''?> alt="<?php echo esc_attr( get_bloginfo('name') ); ?>">-->
				</a>
			<?php endif; ?>
