		...
		<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			...
			<div class="meta">
				...
				<?php if ( $iron_croma_show_post_author ): ?>
						<?php echo esc_html__('by', 'croma'); ?> <a class="meta-author-link" href="<?php echo get_author_posts_url(get_the_author_meta('ID')); ?>"><?php the_author(); ?></a>
				<?php endif;
				...
				if(!empty($iron_croma_categories_list) && $iron_croma_show_post_categories)
					echo '<span class="post-categories"><i class="fa fa-folder-open-o"></i> '.$iron_croma_categories_list.'</span>';

				$iron_croma_tag_list = get_the_tag_list('',', ');
				if(!empty($iron_croma_tag_list) && $iron_croma_show_post_tags)
					echo '<span class="post-tags"><i class="fa fa-tag"></i> '.$iron_croma_tag_list.'</span>';
				?>
			</div>
