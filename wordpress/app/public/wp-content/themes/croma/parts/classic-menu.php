...
<div class="<?php echo implode(" ", $iron_croma_container_classes); ?>"
	...
	data-use_alternative_logo="<?php echo esc_attr($iron_use_alternative_logo); ?>"
	...
	<!-- social-networks -->
	<ul class="classic-menu-hot-links <?php echo (!empty($_GET["mpos"]) ? esc_attr($_GET["mpos"]) : Iron_Croma::getOption('menu_position', null, 'righttype')); ?>">
