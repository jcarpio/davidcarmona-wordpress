		...
		<div class="footer-row">
			<div class="footer-wrapper">
				<?php if ( Iron_Croma::getOption('footer_bottom_logo', null, get_template_directory_uri().'/images/logo-irontemplates-footer.png') ){
					$iron_croma_output = '<img src="' . esc_url( Iron_Croma::getOption('footer_bottom_logo', null, get_template_directory_uri().'/images/logo-irontemplates-footer.png') ) . '" alt="">';
					echo '<a class="footer-logo-wrap" target="_blank" href="' . Iron_Croma::getOption('footer_bottom_link', null, 'http://irontemplates.com/') .' ">' .  $iron_croma_output . '</a>';
				} ?>
				<div>
					<div class="text footer-copyright"><?php echo apply_filters('the_content', Iron_Croma::getOption('footer_copyright', null, 'Copyright &copy; '.date('Y').' Iron Templates<br>All rights reserved') ); ?></div>
					<div class="text footer-author"><?php echo apply_filters('the_content', Iron_Croma::getOption('footer_credits', null, 'Template crafted by <b>IronTemplate</b>') ); ?></div>
					<div class="clear"></div>
				</div>
			</div>
		</div>
