...
class Iron_Croma{
	...
	public static function setup(){
		require_once( get_template_directory().'/includes/classes/tgmpa.class.php' );
		require_once( get_template_directory().'/includes/classes/iron_croma_archive.class.php' );
		require_once( get_template_directory().'/includes/classes/iron_croma_setup.class.php' );
		require_once( get_template_directory().'/includes/classes/iron_croma_dynamic_styles.class.php' );
		require_once( get_template_directory().'/framework-customizations/theme/hooks.php' );
        require_once( get_template_directory().'/includes/classes/nav.class.php' );

		if( !class_exists('Mobile_Detect') ){
			include_once( get_template_directory().'/includes/classes/Mobile_Detect.php' );
		}
